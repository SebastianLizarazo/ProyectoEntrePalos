...
class ProductosController
{
    ...
    {
        try {
            if (!empty($this->dataProducto['Nombre']) && !empty($this->dataProducto['Referencia']) && !Productos::productoRegistrado($this->dataProducto['Nombre'], $this->dataProducto['Referencia'])) {
